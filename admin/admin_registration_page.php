                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form id="frm" method="post" action="../widget/admin_panel/a_registration.php">
                                <h1> Sign up </h1> 
                                <hr>
                                <p> 
                                ...
                                <p class="change_link"> 
                                    <a class="help" href="admin_help.php">Help</a>
                                    Already a member ?
                                    <a href="admin_login_page.php" class="to_register"> Go and log in </a>
                                </p>
                            </form>
                        </div>
